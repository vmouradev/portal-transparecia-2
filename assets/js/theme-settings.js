...
(function ($) {
    ...
    <div class="cs_theme_config">
      ...
      <div class="cs_config_group">
        ...
        <div class="cs_color_swatch_group">
          <div class="cs_color_swatch active" data-color="#1F77D6" style="background: #1F77D6;"></div>
          ...
          <div class="cs_color_swatch" data-color="#0c4a6e" style="background: #0c4a6e;"></div>
        </div>
      </div>
    ...
    `;
        ...
        // 2. State Management
        const config = {
            color: localStorage.getItem('cs_primary_color') || '#1F77D6',
